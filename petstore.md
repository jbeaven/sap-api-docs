# API: PetApi
## &nbsp; &nbsp; [Operation: add_pet](#markdown-header-op-PetApi-add_pet)
## &nbsp; &nbsp; [Operation: delete_pet](#markdown-header-op-PetApi-delete_pet)
## &nbsp; &nbsp; [Operation: find_pets_by_status](#markdown-header-op-PetApi-find_pets_by_status)
## &nbsp; &nbsp; [Operation: find_pets_by_tags](#markdown-header-op-PetApi-find_pets_by_tags)
## &nbsp; &nbsp; [Operation: get_pet_by_id](#markdown-header-op-PetApi-get_pet_by_id)
## &nbsp; &nbsp; [Operation: update_pet](#markdown-header-op-PetApi-update_pet)
## &nbsp; &nbsp; [Operation: update_pet_with_form](#markdown-header-op-PetApi-update_pet_with_form)
## &nbsp; &nbsp; [Operation: upload_file](#markdown-header-op-PetApi-upload_file)
# API: StoreApi
## &nbsp; &nbsp; [Operation: delete_order](#markdown-header-op-StoreApi-delete_order)
## &nbsp; &nbsp; [Operation: get_inventory](#markdown-header-op-StoreApi-get_inventory)
## &nbsp; &nbsp; [Operation: get_order_by_id](#markdown-header-op-StoreApi-get_order_by_id)
## &nbsp; &nbsp; [Operation: place_order](#markdown-header-op-StoreApi-place_order)
# API: UserApi
## &nbsp; &nbsp; [Operation: create_user](#markdown-header-op-UserApi-create_user)
## &nbsp; &nbsp; [Operation: create_users_with_array_input](#markdown-header-op-UserApi-create_users_with_array_input)
## &nbsp; &nbsp; [Operation: create_users_with_list_input](#markdown-header-op-UserApi-create_users_with_list_input)
## &nbsp; &nbsp; [Operation: delete_user](#markdown-header-op-UserApi-delete_user)
## &nbsp; &nbsp; [Operation: get_user_by_name](#markdown-header-op-UserApi-get_user_by_name)
## &nbsp; &nbsp; [Operation: login_user](#markdown-header-op-UserApi-login_user)
## &nbsp; &nbsp; [Operation: logout_user](#markdown-header-op-UserApi-logout_user)
## &nbsp; &nbsp; [Operation: update_user](#markdown-header-op-UserApi-update_user)
